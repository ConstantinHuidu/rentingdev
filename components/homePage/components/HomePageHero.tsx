...
const HomePageHero = () => {
  return (
    <div className="grid md:grid-cols-5 w-full h-[550px]">
      <div className="relative md:col-span-3 flex flex-col ">
        <div className="absolute top-2 z-10 flex flex-col justify-center items-start gap-1 h-2/5 w-[95%] mt-14 ml-5 md:ml-14 bg-slate-200 dark:bg-slate-600 rounded-l-2xl md:text-5xl font-bold text-indigo-900 dark:text-white">
        ...
        <div className="absolute top-56 z-0 flex justify-around items-center bg-yellow-600 h-2/5 w-[95%] rounded-r-2xl">
