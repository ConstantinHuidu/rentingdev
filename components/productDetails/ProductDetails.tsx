...
const ProductDetails = () => {
  return (
    <div className="container flex flex-col space-y-5 w-[85%] mx-auto my-5 h-[970px] md:h-[740px] justify-between items-center text-gray-700 dark:text-white pt-5">
      {/* Image and details container  */}
      <div className="flex flex-col space-y-5 md:space-y-0 md:space-x-3 md:flex-row w-full h-5/6 justify-center items-center border border-gray-400 rounded-lg">
      ...
      <div className="w-full h-1/6 flex justify-center items-center bg-amber-100">
        Product reviews
      </div>
    </div>
  );
